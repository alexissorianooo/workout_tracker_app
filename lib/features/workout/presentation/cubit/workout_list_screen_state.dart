...
class WorkoutListScreenState with _$WorkoutListScreenState {
  ...
  const factory WorkoutListScreenState.loaded(List<WorkoutModel> workouts) = _WorkoutListScreenLoaded;
  const factory WorkoutListScreenState.empty() = _WorkoutListScreenEmpty;
  const factory WorkoutListScreenState.error(String message) = _WorkoutListScreenError;
}
